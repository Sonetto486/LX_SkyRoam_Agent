...
class Settings(BaseSettings):
    ...
    # MCP服务API密钥（✅ 已修复）
    BAIDU_MAPS_API_KEY: str = os.getenv("BAIDU_MAPS_API_KEY", "")
    AMAP_API_KEY: str = os.getenv("AMAP_API_KEY", "3c860a8217597619941f033146dde8ec")
    TIANDITU_API_KEY: str = os.getenv("TIANDITU_API_KEY", "")
    TIANDITU_API_BASE: str = os.getenv("TIANDITU_API_BASE", "https://api.tianditu.gov.cn")
    # 地图服务提供商配置
    ...
    LOG_TO_CONSOLE: bool = os.getenv("LOG_TO_CONSOLE", "true").lower() == "true"  # 是否输出到控制台
    LOG_TO_FILE: bool = os.getenv("LOG_TO_FILE", "true").lower() == "true"  # 是否输出到文件
